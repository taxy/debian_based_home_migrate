...
Wraps library functions with command-line argument parsing and formatting.
"""
import argparse
import sys
from pkg_tracker_lib import (
    PkgSet,
    get_manual_packages,
...
def print_changes_report(header, new_pkgs, rem_pkgs, clean_recommends: dict, clean_suggests: dict, alternative_deps: dict, removed_label):
...
def main():
    ...
    # --- SAVE SNAPSHOT ---
    if args.create:
        from pkg_tracker_lib import SNAPSHOT_DIR
